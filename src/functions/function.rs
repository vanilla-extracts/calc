...
pub fn greater(
    ...
    match (i, i2) {
        ...
        (Identifier(s), Identifier(s2)) => {
            apply_operator(Identifier(s), Identifier(s2), ram, greater)
        }

        (Rational(s), Identifier(ss)) => {
            apply_operator_reverse(Rational(s.clone()), Identifier(ss.clone()), ram, greater)
        }
        (Identifier(ss), Rational(s)) => apply_operator(Identifier(ss), Rational(s), ram, greater),
        (Identifier(s), Int(i)) => apply_operator(Identifier(s), Int(i), ram, greater),
        (Null, Identifier(s)) => apply_operator(Identifier(s), Null, ram, greater),
        (Identifier(s), Null) => apply_operator(Identifier(s), Null, ram, greater),
        (Int(i), Identifier(s)) => apply_operator_reverse(Int(i), Identifier(s), ram, greater),
        (Identifier(s), Float(i)) => apply_operator(Identifier(s), Float(i), ram, greater),
        (Float(i), Identifier(s)) => apply_operator_reverse(Float(i), Identifier(s), ram, greater),
        (Bool(b), Identifier(s)) => apply_operator_reverse(Bool(b), Identifier(s), ram, greater),
        (Identifier(s), Bool(b)) => apply_operator(Identifier(s), Bool(b), ram, greater),
...
pub fn greater_or_equal(
    ...
    match (i, i2) {
        ...
        (Float(f), Rational(s)) => Bool(f >= s.approx()),
        (Identifier(s), Identifier(s2)) => {
            apply_operator(Identifier(s), Identifier(s2), ram, greater_or_equal)
        }
        ...
        (Identifier(ss), Rational(s)) => {
            apply_operator(Identifier(ss), Rational(s), ram, greater_or_equal)
        }
        (Int(i), Identifier(s)) => {
            apply_operator_reverse(Int(i), Identifier(s), ram, greater_or_equal)
        }
        (Identifier(s), Float(i)) => apply_operator(Identifier(s), Float(i), ram, greater_or_equal),
        (Float(i), Identifier(s)) => {
            apply_operator_reverse(Float(i), Identifier(s), ram, greater_or_equal)
        }
        (Bool(b), Identifier(s)) => {
            apply_operator_reverse(Bool(b), Identifier(s), ram, greater_or_equal)
        }
...
pub fn lesser_or_equal(
    ...
    match (i, i2) {
        ...
        (Float(f), Rational(s)) => Bool(f <= s.approx()),
        (Identifier(s), Identifier(s2)) => {
            apply_operator(Identifier(s), Identifier(s2), ram, lesser_or_equal)
        }
        (Identifier(s), Int(i)) => apply_operator(Identifier(s), Int(i), ram, lesser_or_equal),
        ...
        (Identifier(ss), Rational(s)) => {
            apply_operator(Identifier(ss), Rational(s), ram, lesser_or_equal)
        }
        (Null, Identifier(s)) => apply_operator(Identifier(s), Null, ram, lesser_or_equal),
        (Identifier(s), Null) => apply_operator(Identifier(s), Null, ram, lesser_or_equal),
        (Int(i), Identifier(s)) => {
            apply_operator_reverse(Int(i), Identifier(s), ram, lesser_or_equal)
        }
        (Identifier(s), Float(i)) => apply_operator(Identifier(s), Float(i), ram, lesser_or_equal),
        (Float(i), Identifier(s)) => {
            apply_operator_reverse(Float(i), Identifier(s), ram, lesser_or_equal)
        }
        (Bool(b), Identifier(s)) => {
            apply_operator_reverse(Bool(b), Identifier(s), ram, lesser_or_equal)
        }
        (Identifier(s), Bool(b)) => apply_operator(Identifier(s), Bool(b), ram, lesser_or_equal),
